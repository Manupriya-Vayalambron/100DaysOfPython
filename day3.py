...
choice = input('\t Type "left" or "right"\n ').lower()  # convert input to lowercase to handle case-insensitive input

# First decision point
if choice == "left":
    print("You've come to a lake. There is an island in the middle of the lake.")
    
    # Ask the player how to cross the lake
    ...
    if lake == "wait":
        ...
        # Third decision point - door choice
        if door == "yellow":
            print("You Won")  # Winning condition
        elif door == "red":
